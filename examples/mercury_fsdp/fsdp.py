...
# distribution.
#
# SST driver for the FSDP / ZeRO-3 step (fsdp.cu). nranks = the sharded data-parallel
# group; FSDP_PREFETCH (read by the skeleton) is the study knob. Mirrors train.py.
...
if __name__ == "__main__":
    ...
    params = {
        "app1.name": "mercury_fsdp",
        "app1.exe_library_name": "mercury_fsdp",
